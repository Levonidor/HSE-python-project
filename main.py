...
st.write(
    "Our data frame contains data about games with sales greater than 100,000 copies: their sales, on which platforms they were sold, by which publishers, year of release and in which markets how many were sold."
)
st.write(
...
genre = st.selectbox("Choose Genre:", genres_present)
...
st.write(
    "You can also check other platforms yourself and draw similar conclusions using the window below."
)


platform = st.selectbox("Choose Platform:", platforms_present)
...
if st.checkbox(
    "Show **dataframe with Genre and its number of games with global sales over 10 million**"
):
